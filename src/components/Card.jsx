...
import { handleActive, handleLiked, setCarts } from "../reducers/cart";
...
const Card = ({ item }) => {
    ...
    const isLiked = items.find((i) => i.id === item.id)?.isLiked || false;
    ...
    return (
        ...
        >
            <div className="relative group border-t-[5px] border-[#fff] group-hover:border-[--primary] duration-300 transition-all">
                <img src={item.image_url} alt="" className="h-[300px] w-full" />
