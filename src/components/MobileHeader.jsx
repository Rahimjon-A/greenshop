        ...
        <div className="bg-white w-full h-[94px] text-center mx-auto">
            <ul className="grid grid-cols-5 place-content-center h-full justify-center items-center">
                ...
                onClick={() => dispatch(handleActive(0))}
                    className={` ${active == 0 ? "text-[--primary] scale-110 ": "text-[--text] "} flex cursor-pointer justify-center text-[24px] `}
                >
                    <GoHomeFill />
                </li>
                </Link>
                ...
                onClick={() => dispatch(handleActive(1))}
                    className={` ${active == 1 ? "text-[--primary] scale-110 ": "text-[--text] "} flex cursor-pointer justify-center text-[24px]`}
                >
                    <FaHeart />
                </li>
                </Link>
                ...
                onClick={() => dispatch(handleActive(2))}
                    className={` ${active == 2 ? "text-[--primary] scale-110 ": "text-[--text] "}flex cursor-pointer justify-center text-[24px]  `}
                >
                ...
                onClick={() => dispatch(handleActive(3))}
                    className={` ${active == 3 ? "text-[--primary] scale-110 ": "text-[--text] "} flex cursor-pointer justify-center text-[24px]  `}
                >
                    <FaUserAlt />
                </li>
                </Link>
